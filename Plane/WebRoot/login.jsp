                    ...
                    <form class="form-group" action="tologin.do" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control required" type="text" placeholder="Username" id="username" name="username"
                                autofocus="autofocus" maxlength="20" value="${user_name }"/>
                        </div>
                        <div class="form-group">
                            <i class="fa fa-lock fa-lg"></i>
                            <input class="form-control required" type="password" placeholder="Password" id="password"
                                name="password" maxlength="15" value="${user_pwd }"/>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="register.jsp" id="register_btn" class="pull-left">还没有账号？点我注册</a>
                        <a href="admin.jsp" id="admin_btn" class="pull-right">管理员</a>
                    </form>
                </div>
            </div>
        </div>

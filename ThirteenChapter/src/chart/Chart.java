...
public class Chart extends JApplet{
	public void init()
	{
		EventQueue.invokeLater(() -> {
			...
			for(int i = 0; i < n; i++)
			{
				values[i] = java.lang.Double.parseDouble(getParameter("value." + (i + 1)));
...
class ChartComponent extends JComponent
{
	 ...
	 * @param values the array of values for the chart
	 * @param names the array of names for the values

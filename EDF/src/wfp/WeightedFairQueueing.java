...
/**
 * @XinCheng 2018年3月30日 Administrator
 * WFQ(WeightedFairQueueing)仍然会将数据分组分往不同的队列，
 * 但是，每个队列都有各自的权重，系统以轮换的方式来处理每个队列中的分组，并且所处理的分组数量等于相应队列的权重。
 */
 ...
 * 改进QoS的技术。
 * <p/>
 * 调度算法：加权公平队列（WeightedFairQueueing）算法
 * <p/>
 * 
 * @author HouLei
 * 
...
public class WeightedFairQueueing<E> {
	...
	public static void main(String[] args) {
		...
		// 创建WFQ对象
		WeightedFairQueueing<DataPackage> wfq = new WeightedFairQueueing<DataPackage>(weights, cf);
		// 添加数据分组
		int index = 1;
		for (int i = 0; i < 6; i++) {

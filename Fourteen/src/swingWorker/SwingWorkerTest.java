 ...
 * @XinCheng 2018年1月19日 Administrator
 *
 */
...
/**
 * This frame has a text area to show the contents of a text file, a menu to open a file and cancel the opening process, and a status line to show the file loading progress.
 * @XinCheng 2018年1月19日 Administrator
 *
 */
		...
		public StringBuilder doInBackground() throws IOException, InterruptedException
		{
			...
			try(Scanner in = new Scanner(new FileInputStream(file), "UTF-8"))
			{
				while(in.hasNextLine())
				{
					...
					data.line = line;
					publish(data);
					//Thread.sleep(1); //to test cancellation
				}
			}
			return text;
		}

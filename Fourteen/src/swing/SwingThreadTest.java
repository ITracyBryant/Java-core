 ...
 * This can result in errors because the combo box methods are not synchronized and both the worker thread and the event dispatch thread access the combo box.
 * @XinCheng 2018年1月19日 Administrator
 *
 */
